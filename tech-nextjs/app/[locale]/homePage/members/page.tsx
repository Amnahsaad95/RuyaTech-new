...
import { MagnifyingGlassIcon, FunnelIcon, XMarkIcon, CheckIcon, ChevronDownIcon, ArrowUpIcon, ArrowDownIcon } from '@heroicons/react/24/outline';
...
export default function UsersPage() {
  ...
  const sortOptions: SortOption[] = useMemo(() => [
    { field: 'name', direction: 'asc', label: t('sort_options.name_asc') },
    { field: 'name', direction: 'desc', label: t('sort_options.name_desc') },
    { field: 'createdAt', direction: 'desc', label: t('sort_options.newest') },
    { field: 'createdAt', direction: 'asc', label: t('sort_options.oldest') },
    { field: 'experience', direction: 'desc', label: t('sort_options.most_experience') },
    { field: 'experience', direction: 'asc', label: t('sort_options.least_experience') },
  ], [t]);
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        setUsers(data.users.filter((user:User)=> (user.role !== 'admin'&& user.status =='approved')));
        setLoading(false);
      } catch (error) {
  ...
  // Filter and sort users based on current filters and sort option
  const filteredUsers = useMemo(() => {
    ...
    if (filters.role === 'professional') {
      ...
      if (filters.skills.length > 0) {
        result = result.filter(u =>
          filters.skills.every(filterSkill =>
            Array.isArray(u.bio?.skills_learning) &&
            u.bio.skills_learning.some(userSkill =>
              typeof userSkill === 'string' && userSkill.toLowerCase().includes(filterSkill.toLowerCase())
            )
          )
        )
      }
      ...
      if (filters.services.length > 0) {
        result = result.filter(u =>
          filters.services.every(filterService =>
            u.bio?.services?.some(service => typeof service === "string" && service.toLowerCase().includes(filterService.toLowerCase())
            )
          )
        );
      }
    ...
    result.sort((a, b) => {
      switch (sortOption.field) {
        ...
        case 'experience':
          ...
          return sortOption.direction === 'asc' ? expA - expB : expB - expA;
        default:
          return 0;
      }
    });
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" dir={dir}>
      ...
      <div className="flex flex-col items-center text-center mb-8">
        ...
        <div className={`flex flex-wrap justify-center gap-3 mt-6 ${isRTL ? 'flex-row-reverse' : ''}`}>
          
          {/* Sort dropdown */}
          <div className="relative">
            <button
              onClick={() => setShowSortDropdown(!showSortDropdown)}
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 transition-all shadow-sm"
            >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
              showFilters ? 'bg-gray-200 text-gray-800' : 'bg-orange-600 text-white hover:bg-orange-700'
            } shadow-sm`}
          >
            {showFilters ? (
              <>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {filters.role && (
          <div className="flex items-center bg-orange-100 text-orange-800 px-3 py-1 rounded-full text-sm shadow-sm">
        ...
        {filters.search && (
          <div className="flex items-center bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm shadow-sm">
        ...
        {filters.location && (
          <div className="flex items-center bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm shadow-sm">
        ...
        {filters.skills.map((skill, i) => (
          <div key={i} className="flex items-center bg-orange-100 text-orange-800 px-3 py-1 rounded-full text-sm shadow-sm">
        ...
        {filters.interests.map((interest, i) => (
          <div key={i} className="flex items-center bg-pink-100 text-pink-800 px-3 py-1 rounded-full text-sm shadow-sm">
        ...
        {filters.services.map((service, i) => (
          <div key={i} className="flex items-center bg-amber-100 text-amber-800 px-3 py-1 rounded-full text-sm shadow-sm">
        ...
        {filters.industry.map((industry, i) => (
          <div key={i} className="flex items-center bg-emerald-100 text-emerald-800 px-3 py-1 rounded-full text-sm shadow-sm">
        ...
        {filters.hiring && (
          <div className="flex items-center bg-red-100 text-red-800 px-3 py-1 rounded-full text-sm shadow-sm">
            {t('filters.hiring')}
            <button 
      ...
      {/* Filters panel */}
      {showFilters && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8 transition-all duration-300">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full ${isRTL ? 'pr-10 pl-3' : 'pl-10 pr-3'} py-2 border border-gray-300 rounded-lg bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 sm:text-sm`}
            ...
            <div>
              ...
              <select
                ...
                className="block w-full pl-3 pr-10 py-2 text-base border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 sm:text-sm rounded-lg"
              >
            ...
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-3 pr-3 py-2 border border-gray-300 rounded-lg bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
              ...
              <>
                ...
                <div className="md:col-span-2 lg:col-span-3">
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    {filters.skills.map((skill, i) => (
                      <span key={i} className="inline-flex items-center bg-orange-100 text-orange-800 px-3 py-1 rounded-full text-sm shadow-sm">
                        {skill}
                        <button 
                          onClick={() => removeTag('skills', skill)}
            ...
            {filters.role === 'student' && (
              <>
                ...
                <div className="md:col-span-2 lg:col-span-3">
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    {filters.skills.map((skill, i) => (
                      <span key={i} className="inline-flex items-center bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm shadow-sm">
                        {skill}
                        <button 
                          onClick={() => removeTag('skills', skill)}
                ...
                <div className="md:col-span-2 lg:col-span-3">
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    {filters.interests.map((interest, i) => (
                      <span key={i} className="inline-flex items-center bg-pink-100 text-pink-800 px-3 py-1 rounded-full text-sm shadow-sm">
                        {interest}
                        <button 
                          onClick={() => removeTag('interests', interest)}
            ...
            {filters.role === 'company' && (
              <>
                ...
                <div className="md:col-span-2 lg:col-span-3">
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    {filters.services.map((service, i) => (
                      <span key={i} className="inline-flex items-center bg-amber-100 text-amber-800 px-3 py-1 rounded-full text-sm shadow-sm">
                        {service}
                        <button 
                          onClick={() => removeTag('services', service)}
                ...
                <div className="md:col-span-2 lg:col-span-3">
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    {filters.industry.map((industry, i) => (
                      <span key={i} className="inline-flex items-center bg-emerald-100 text-emerald-800 px-3 py-1 rounded-full text-sm shadow-sm">
                        {industry}
                        <button 
                          onClick={() => removeTag('industry', industry)}
